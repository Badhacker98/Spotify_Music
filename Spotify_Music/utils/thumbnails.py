...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("Spotify_Music/assets/Bad/font2.ttf", 30)
    font = ImageFont.truetype("Spotify_Music/assets/Bad/font.ttf", 30)
    title_font = ImageFont.truetype("Spotify_Music/assets/Bad/font3.ttf", 45)
    ...
    play_icons = Image.open("Spotify_Music/assets/Bad/play_icons.png")
