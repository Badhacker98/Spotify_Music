...
from Spotify_Music.utils.database import get_assistant, get_authuser_names, get_cmode
from Spotify_Music.utils.decorators import ActualAdminCB, AdminActual, language
from Spotify_Music.utils.formatters import alpha_to_int, get_readable_time
...
async def restartbot(client, message: Message, _):
    ...
    if chat_id:
        ...
        try:
            db[chat_id] = []
            await Spotify.stop_stream_force(chat_id)
        except:
            pass
